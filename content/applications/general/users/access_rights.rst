...
.. tip::
   An alternative to using the :guilabel:`🪲 (debug)` menu to activate *Superuser mode* is to login
   as a superuser. To do so navigate to the login screen and enter the appropriate :guilabel:`Email`
